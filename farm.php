...
$query = "SELECT profile_photo, name, district, email, phone_number FROM Details WHERE role = 'Farmer'";
...
<body>
    ...
    <h2>Farmers with ready vanilla produce</h2>
        ...
        <?php while ($buyer = mysqli_fetch_assoc($result)): ?>
            ...
            <div class="buyer-item">
                ...
                <div class="buyer-details">
                   ...
                   <!-- <p><strong>Current Price:</strong> <?php echo htmlspecialchars($buyer['price']); ?></p>-->
                </div>
